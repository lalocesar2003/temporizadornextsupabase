        ...
        <section className="rounded-3xl border border-slate-800 bg-slate-900/80 p-6 shadow-2xl shadow-slate-950/40">
          <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
            <div className="space-y-3">
              <div className="inline-flex items-center gap-2 rounded-full border border-sky-900/60 bg-sky-950/40 px-3 py-1 text-xs font-medium uppercase tracking-[0.18em] text-sky-300">
                <Clock3 className="h-3.5 w-3.5" />
                Temporizador
              </div>
              <h1 className="text-3xl font-semibold tracking-tight text-slate-50 md:text-4xl">
                Temporizador de registro de concentracion
              </h1>
              <p className="max-w-2xl text-sm leading-6 text-slate-400 md:text-base">
                Usa un contador simple, guarda cada inicio con minutos y etiqueta, y
                consulta el ultimo registro sin mezclarlo con el dashboard principal.
              </p>
            </div>
            ...
            <div className="space-y-5">
              ...
              <label className="block text-sm text-slate-300">
                ...
                <input
                  ...
                  placeholder="Ej: enfoque, lectura, trabajo..."
                  className="mt-2 w-full rounded-2xl border border-slate-700 bg-slate-950/70 px-4 py-3 outline-none"
                  disabled={running}
                  maxLength={80}
                />
              ...
              <p className="text-center text-xs text-slate-500">
                ...
                fecha, la hora, los minutos configurados y la etiqueta.
              </p>
            </div>
          </div>
